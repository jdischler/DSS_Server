...
//
//------------------------------------------------------------------------------
public class Models_Default_T
{
	
	//--------------------------------------------------------------------------
	public void Calculate_T(String Output_Folder)
	{
		Layer_Base layer;
		int NO_DATA = -9999;
		// Columns
		...
		try 
		{
			...
			for (int y = 0; y < height; y++) 
			{
				...
				{
					Rotation[y][x] = Float.parseFloat(rot[x]);
				}
			}
			...
			for (int y = 0; y < height; y++) 
			{
				...
				{				
					...
					else
					{
						...
						//Grass_Mask
						else if (Rotation[y][x] == 8 || Rotation[y][x] == 9)
						{
						...
						for (int j = mWin.ULY; j <= mWin.LRY; j++) 
						{
							for (int i = mWin.ULX; i <= mWin.LRX; i++) 
							{
								if (Rotation[j][i] != -9999)
								{
									mWin.Total++;
								// Ag Mask
								if (Rotation[j][i] == 1 || Rotation[j][i] == 2 || Rotation[j][i] == 3 || Rotation[j][i] == 4 || Rotation[j][i] == 5 || Rotation[j][i] == 6 || Rotation[j][i] == 7 || Rotation[j][i] == 10)
									{
										Count_Ag = Count_Ag + 1;	
									}
									// Forest Mask
									else if (Rotation[j][i] == 11)
									{
						...
						int Crop_Type = 0;
						// Ag Mask
						if (Rotation[y][x] == 1 || Rotation[y][x] == 2 || Rotation[y][x] == 3 || Rotation[y][x] == 4 || Rotation[y][x] == 5 || Rotation[y][x] == 6 || Rotation[y][x] == 7 || Rotation[y][x] == 10)
						{
							Crop_Type = 0;	
						}
						// Grass Mask
